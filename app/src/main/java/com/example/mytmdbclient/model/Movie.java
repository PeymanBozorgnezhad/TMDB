...
public class Movie extends BaseObservable implements Parcelable
{
    ...
    @Expose
    private String posterPath;//BindingAdapter

    @BindingAdapter({"posterPath"})
    public static void loadImage(ImageView imageView, String imageURL) // value string posterPath = string URL(imagePath)
    //dar in qesmat meqdar imageURL man faqat shamel posterPath has va shamel address asli(url) nis .pas ba set kardan dar adapter in moskel hal mishavad
    {

        String imagePath = "https://image.tmdb.org/t/p/w500" + imageURL;//imageURL hamon TempValues.get(position) in Adapter
