...
public class UpComing extends BaseObservable implements Parcelable
{
    ...
    public static void LoadImageUpComing(ImageView imageView, String imageURL)
    {
    ...
    public final static Parcelable.Creator<UpComing> CREATOR = new Creator<UpComing>()
    {
    ...
    public static final DiffUtil.ItemCallback<UpComing> CALLBACK = new DiffUtil.ItemCallback<UpComing>()
    {
        @Override
        public boolean areItemsTheSame(@NonNull UpComing oldItem, @NonNull UpComing newItem)
        {
        ...
        @Override
        public boolean areContentsTheSame(@NonNull UpComing oldItem, @NonNull UpComing newItem)
        {
            return true;
        }
    };
