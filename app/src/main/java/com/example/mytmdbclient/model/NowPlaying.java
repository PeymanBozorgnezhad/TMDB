...
public class NowPlaying extends BaseObservable implements Parcelable
{
    ...
    public static void LoadImageNowPlaying(ImageView imageView, String imageURL)
    {
...
*/
    ...
    public static final DiffUtil.ItemCallback<NowPlaying> CALLBACK = new DiffUtil.ItemCallback<NowPlaying>()
    {
        @Override
        public boolean areItemsTheSame(@NonNull NowPlaying oldItem, @NonNull NowPlaying newItem)
        {
            return oldItem.id == newItem.id;
        }

        @Override
        public boolean areContentsTheSame(@NonNull NowPlaying oldItem, @NonNull NowPlaying newItem)
        {
            return true;
        }
    };
